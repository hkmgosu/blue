...
import styles from './size-button-grid-mobile.module.scss';
...
function NewShippingLayoutSizeButtonGridMobile({
  children,
}: Props): JSX.Element {
  ...
  const handleClickLeft = useCallback(() => {
    ...
    if (nodeWidth) {
      ...
      setTranslateSlide((nodeWidth / 2) * -(current - 1));
    }
  }, [current, nodeWidth]);
...
export default NewShippingLayoutSizeButtonGridMobile;
