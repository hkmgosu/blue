...
const MainRightCreatePymeBg: FC = () => {
  return (
    <MainRight>
      <MainRightWrapper>
        <CurveBoxMobile>
        ...
        <IntroImageBox>
          <IntroImage src={inscribeempresa} />
        </IntroImageBox>
      </MainRightWrapper>
    </MainRight>
  );
...
const CurveBox = styled.div`
  ...
  @media (min-width: 1200px) {
    ...
    top: 0;
    bottom: 0;
    left: calc(((100vw / 2) - (535px)) * -1);
  }
  @media (min-width: 1400px) {
    left: calc(((100vw / 2) - (719px)) * -1);
  }
  @media (min-width: 3000px) {
    left: calc(((100vw / 2) - (1314px)) * -1);
  }
`;
...
export default MainRightCreatePymeBg;
