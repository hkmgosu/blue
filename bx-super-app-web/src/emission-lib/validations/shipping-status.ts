...
export const shippingStatusSchema = yup.object().shape({
  ...
  origin: yup.object().shape({
    ...
    address: yup.object().shape({
      ...
      region: yup.object().shape({
        name: yup.string().required('Origen: El origen es requerido'),
        region_number: yup.string().required('Origen: El origen es requerido'),
        region_iso_3166: yup
          .string()
  ...
  package: yup.array().of(
    yup.object().shape({
      ...
      shipping_service: yup.object().shape({
        codeDestination: yup
          .string()
          .required('Tipo de Servicio: Se debe seleccionar el Tipo de Servicio')
          .min(3, 'Tipo de Servicio: Se debe seleccionar el Tipo de Servicio'),
        codeOrigin: yup
          .string()
          .required('Tipo de Servicio: Se debe seleccionar el Tipo de Servicio')
          .min(3, 'Tipo de Servicio: Se debe seleccionar el Tipo de Servicio'),
